...
ActiveRecord::Schema[7.0].define(version: 2023_05_21_225115) do
  ...
  create_table "usercomments", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.integer "parent_id"
    t.index ["message_id"], name: "index_usercomments_on_message_id"
  ...
  add_foreign_key "usercomments", "messages"
